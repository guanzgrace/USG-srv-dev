...
You've subscribed to %s via PrincetonPounce!  We'll send you an email if seats in the class open up.
	...
	def sendNotification(self):
		if self.type == EMAIL:
			...
			body = """A spot has opened up in. If the class fills up before you can make it to SCORE, you'll have to resubscribe for notifications here:\n <http://princetonpounce.com/reactivate/%s.""" % (str(self.theclass), str(self.pk))
  			return emails.sendMail(self.address, subject, body)
