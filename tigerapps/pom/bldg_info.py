...
BLDG_INFO = {
    ...
    'ALEXH': ('Alexander Hall',('Alexander Beach',),True),
    ...
    'BLAIR': ('Blair/Buyers Hall',('Blair Arch',),True),
    ...
    'DILLG': ('Dillon Gym',('Stephens Fitness Center', 'Club Sports',),True),
    ...
    'FIRES': ('Firestone Library',('Firestone',),True),
    ...
    'HAMIL': ('Hamilton Hall',('Mathey College',),True),
    ...
    'MADIH': ('Madison Hall',('Rockefeller College',),True),
    ...
    'NA185': ('Nassau Street, 185',('185 Nassau Street',),True),
    'NA201': ('Nassau Street, 201',('201 Nassau Street',),True),
    ...
    'WILCH': ('Wu/Wilcox Hall',('Butler College', 'Wilson College',),True),
    ...
    'MCCAR': ('McCarter Theatre',('McCarter Theatre Center',),True),
    ...
    'MCDON': ('McDonnell Hall of Physics',('McDonnell',),True),
