...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Event', fields ['event_webcal_uid']
        db.delete_unique('cal_event', ['event_webcal_uid'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Event', fields ['event_webcal_uid']
        db.create_unique('cal_event', ['event_webcal_uid'])
    ...
    models = {
        ...
        'cal.event': {
            ...
            'event_webcal_uid': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'cal.eventcategory': {
        ...
        'cal.eventcluster': {
            ...
            'cluster_tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'tag_clusters'", 'symmetrical': 'False', 'to': "orm['cal.EventCategory']"}),
