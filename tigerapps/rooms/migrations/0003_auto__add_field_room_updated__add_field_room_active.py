...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Room.updated'
        db.add_column('rooms_room', 'updated', self.gf('django.db.models.fields.DateField')(default=datetime.date(2009, 3, 25)), keep_default=False)

        # Adding field 'Room.active'
        db.add_column('rooms_room', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Room.updated'
        db.delete_column('rooms_room', 'updated')

        # Deleting field 'Room.active'
        db.delete_column('rooms_room', 'active')
