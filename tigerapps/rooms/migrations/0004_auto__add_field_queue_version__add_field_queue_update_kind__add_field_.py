...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Queue.version'
        db.add_column('rooms_queue', 'version', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Queue.update_kind'
        db.add_column('rooms_queue', 'update_kind', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)

        # Adding field 'Queue.update_user'
        db.add_column('rooms_queue', 'update_user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['rooms.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Queue.version'
        db.delete_column('rooms_queue', 'version')

        # Deleting field 'Queue.update_kind'
        db.delete_column('rooms_queue', 'update_kind')

        # Deleting field 'Queue.update_user'
        db.delete_column('rooms_queue', 'update_user_id')
